...
class ScoreScreenPHQ extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String report;
    var icon = _qnControllerPHQ.totalScore <= 9
    ...
    if (_qnControllerPHQ.totalScore <= 4) {
      report =
          "Hooray! You have minimal anxiety. Keep smiling in the future :)!";
      ...
      report =
          " You have moderately severe depression. Please give yourself a little break. Try your favorite food, go hiking with friends, or just watch the beautiful sunrise tomorrow!";
