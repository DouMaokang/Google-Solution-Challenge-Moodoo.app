...
class _ReportPageState extends State<ReportPage> {
  Future<Map> _getData() async {
    ...
    print(days);
    return {"username": username,"sessions": recordList.length + gadList.length + phqList.length, "days": days.length};
  }
                      ...
                      children: [
                        ...
                        Center(
                          child: CircleAvatar(
                            ...
                            child: Text('${_username[0].toUpperCase()}${_username[1].toUpperCase()}',
                              style: TextStyle(
